...
return new class extends UpdatePatcher
{
    ...
    {
        foreach ($this->getColumnIndexes('companies', 'email') as $key) {
    ...
    {
        foreach ($this->getColumnIndexes('companies', 'domain') as $key) {
            if (str_ends_with($key->Key_name, 'domain_index') && $key->Index_type == 'BTREE') {
                return $key->Key_name;
            }
        }
    }
    ...
    {
        foreach ($this->getColumnIndexes('companies', 'name') as $key) {
