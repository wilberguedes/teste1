...
return [
    ...
    'settings' => [
        ...
        'update' => 'Поля редактирования/предварительного просмотра',
    ...
    'options' => 'Параметры',
    'is_unique' => 'Не допускать дублирования значений',
    'is_unique_change_info' => 'Значение этой опции можно установить только при создании поля.',
    'validation' => [
