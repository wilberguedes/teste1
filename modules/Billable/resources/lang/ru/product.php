...
return [
    ...
    'deal_info' => 'Свяжите товары со сделкой, чтобы создать список товаров, с которыми связана сделка, сумма сделки автоматически рассчитывается на основе добавленных товаров.',
    'exists_in_trash_by_name' => 'Товар с таким названием уже находится в корзине. Восстановить удаленный товар?',
    'add_to_deal' => 'Добавьте товары в сделку',
