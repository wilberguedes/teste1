    ...
    <ol class="divide-y divide-neutral-300 rounded-md border border-neutral-300 md:flex md:divide-y-0">
        ...
        <li class="relative md:flex md:flex-1">
            <a href="#" class="pointer-events-none flex items-center px-6 py-4 text-sm font-medium">
                <span
                    class="{{ $step == 1 ? 'border-2 border-primary-600' : 'bg-primary-600' }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
                    @if ($step > 1)
        ...
        <li class="relative md:flex md:flex-1">
            <a href="#" class="group pointer-events-none flex items-center">
                <span class="flex items-center px-6 py-4 text-sm font-medium">
                    <span
                        class="{{ $step == 2 ? 'border-2 border-primary-600' : ($step > 2 ? 'bg-primary-600' : 'border-2 border-neutral-300') }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
                        @if ($step > 2)
                            <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
        ...
        <li class="relative md:flex md:flex-1">
            <a href="#" class="group pointer-events-none flex items-center">
                <span class="flex items-center px-6 py-4 text-sm font-medium">
                    <span
                        class="{{ $step == 3 ? 'border-2 border-primary-600' : ($step > 3 ? 'bg-primary-600' : 'border-2 border-neutral-300') }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
                        @if ($step > 3)
                            <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
        ...
        <li class="relative md:flex md:flex-1">
            <a href="#" class="group pointer-events-none flex items-center">
                <span class="flex items-center px-6 py-4 text-sm font-medium">
                    <span
                        class="{{ $step == 4 ? 'border-2 border-primary-600' : ($step > 4 ? 'bg-primary-600' : 'border-2 border-neutral-300') }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
                        @if ($step > 4)
                            <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
        ...
        <li class="relative md:flex md:flex-1">
            <a href="#" class="group pointer-events-none flex items-center">
                <span class="flex items-center px-6 py-4 text-sm font-medium">
                    <span
                        class="{{ $step == 5 ? 'bg-primary-600' : 'border-2 border-neutral-300' }} flex h-10 w-10 shrink-0 items-center justify-center rounded-full">
                        @if ($step == 5)
                            <svg class="h-6 w-6 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd"
